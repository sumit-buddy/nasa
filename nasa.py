...
animation = ["[Processing your request | ]","[Processing your request / ]", "[Processing your request - ]", "[Processing your request \ ]"]
...
print ("\n")
#checking vulnerabilies <success>
#resolving host.........<success>
#preparing bruteforce...<success>
#attacking local ftp....<success>
#testing network flow...<success>
#sending payload........<success>
#fetching chache data...<success>
...
#firewall security......<CROSSED>
#control over ftp.........<DONE!>
#MITM over system........<PASSED>
#main database...........<HACKED>
#all secret files........<STOLEN>
#admin panel info........<HACKED>
#system database.........<HACKED>
#system overtaken..........<DONE>
print ("\n")
print ("\033[1;36;40mFinalising \033[0m")
animation_1 = ["server controllers......<HACKED>[•+++++++++]","administration pass....<FETCHED>[••++++++++]", "firewall security......<CROSSED>[•••+++++++]", "control over ftp.........<DONE!>[••••++++++]", "MITM over system........<PASSED>[•••••+++++]", "main database...........<HACKED>[••••••++++]", "all secret files........<STOLEN>[•••••••+++]", "admin panel info........<HACKED>[••••••••++]", "system database.........<HACKED>[•••••••••+]", "system overtaken..........<DONE>[••••••••••]"]

for j in range(len(animation_1)):
    time.sleep(0.3)
    sys.stdout.write("\r" + animation_1[j % len(animation_1)])
    sys.stdout.flush()
